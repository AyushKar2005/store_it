...
const Search = () => {
    ...
    const [results, setResults] = useState<Models.Document[]>([]); // ✅ always an array
        ...
        <div className="search">
            <div className="search-input-wrapper">
                ...
                {open && <ul className="search-result">
                    {results.length > 0 ? (
                        results.map((file)=><li className="flex items-center justify-between" key={file.$id} onClick={()=>handleClickItem((file))}>
